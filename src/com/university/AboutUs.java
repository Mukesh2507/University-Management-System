...
public class AboutUs extends JFrame{
    ...
    public AboutUs() {
        ...
        super("About Us - Silveroak University");
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("com/university/icons/logo.jpg"));
        ...
        JLabel l6 = new JLabel("Developed By : mk labana");
        ...
        JLabel l8 = new JLabel("Contact : mukeshlabana844@gmail.com");
        l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l8.setBounds(70, 290, 600, 34);
        contentPane.add(l8);

        JLabel l9 = new JLabel("Education - B.E (IT)");
        l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
        l9.setBounds(70, 320, 600, 34);
        contentPane.add(l9);


        JLabel l10 = new JLabel("Phone - +91 9909593162");
